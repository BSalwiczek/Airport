...
public class InitializeData {
    ...
    private synchronized void init() {
        ...
        Airplane a1 = Airplane.builder().airplaneModel(boeing737).mileage(10000).build();
        Airplane a2 = Airplane.builder().airplaneModel(boeing747).mileage(12312).build();
        Airplane a3 = Airplane.builder().airplaneModel(airbusA320).mileage(42233).build();
